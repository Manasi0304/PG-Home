...
function AddNewProperty() {
    ...
    return (
        <form onSubmit={handleSubmit} className="add-property-form">
            ...
            <input type="text" name="tenantType" placeholder="Tenant Type" onChange={handleChange} required />
            <input type="text" name="rentingOption" placeholder="Renting Option" onChange={handleChange} required />
